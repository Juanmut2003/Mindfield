...
- **Tests**: Vitest.
- **Fachlogik**: Der Daten-Layer für das Mental-Health-Tracking (Mood-Einträge, Journal, Selbst-Checks) ist implementiert – inklusive verschlüsselter lokaler Speicherung und einer abgesicherten Brücke zur UI. Gebaut sind die Bildschirme Startseite, Kalender und Journal; Stimmungs- und Journaleinträge werden dort tatsächlich erfasst und angezeigt. Noch Beispieldaten sind die Fitness-Kacheln und die Kalendertermine. Die Bereiche Aktivitäten, KI-Assistent und Kontakte sind noch nicht gebaut.
- **Speicherung**: Mental-Health-Daten liegen ausschließlich lokal auf dem Rechner des Nutzers (eine Datei im persönlichen App-Datenordner). Es werden keine Daten an einen Server gesendet. Die Datei ist **verschlüsselt** – der Schlüssel kommt vom Betriebssystem und ist an das Benutzerkonto gebunden, es ist also kein Passwort nötig. Wichtig: Wird der App-Datenordner gelöscht oder die App deinstalliert, sind die Einträge nicht mehr lesbar – eine Sicherung der Datendatei allein genügt daher nicht.
